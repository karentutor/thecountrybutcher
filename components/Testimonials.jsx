      ...
      <Swiper loop={true} modules={[Autoplay]} autoplay={true}>
        {testimonials.map((item) => (
          <SwiperSlide key={item.id}>
            <div className='grid grid-cols-1 lg:grid-cols-4 max-w-6xl px-6 mx-auto gap-10'>
              <div className='flex flex-col col-span-3'>
                <p className='text-xl md:text-2xl font-medium mt-6 border-solid border-l-4 border-accent-900 pl-[12px] text-secondary-900'>
                  {item.quote}
                </p>
